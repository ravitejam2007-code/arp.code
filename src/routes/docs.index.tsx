...
export const Route = createFileRoute("/docs/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "What ARPCODE is, what it isn't, and how to get started in 60 seconds.",
      },
...
function DocsIndex() {
  return (
    ...
    >
      <P>
        These docs cover installation, configuring providers, the slash-command reference, the
        built-in tool system, and the configuration schema. If you're new, start with{" "}
        <Link to="/docs/install" className="text-primary underline-offset-4 hover:underline">
          Install
        </Link>
        .
      </P>
      ...
      <P>
        ...
        (OpenRouter, Ollama, Groq, Gemini). It can read your code, propose plans, execute tools, and
        persist conversations — all from the terminal.
      </P>
      ...
      <ul className="space-y-1.5 list-none pl-0">
        {[
          ...
          <li key={href} className="border-l-2 border-border hover:border-primary pl-4 py-1">
            <Link to={href} className="font-mono text-primary">
              {t}
            </Link>
